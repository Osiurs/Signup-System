...
namespace RegistrationManagementAPI.Migrations
{
    ...
    [Migration("20241130141609_AddUserIdToTeachers")]
    partial class AddUserIdToTeachers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RegistrationManagementAPI.Entities.Student", b =>
                {
                    b.HasOne("RegistrationManagementAPI.Entities.User", "User")
                        .WithOne("Student")
                        .HasForeignKey("RegistrationManagementAPI.Entities.Student", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RegistrationManagementAPI.Entities.Teacher", b =>
                {
                    b.HasOne("RegistrationManagementAPI.Entities.User", "User")
                        .WithOne("Teacher")
                        .HasForeignKey("RegistrationManagementAPI.Entities.Teacher", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
